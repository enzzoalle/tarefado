...
urlpatterns = [
    ...
    path('novo_comentario/<int:materia_id>', views.novo_comentario, name='novo_comentario'),
    path('editar_comentario/<int:comentario_id>', views.editar_comentario, name='editar_comentario'),
    path('materias/excluir/<int:comentario_id>', views.excluir_comentario, name='excluir_comentario'),
]